            ...
            >
              {/* <li className="social-icons-google">
                <Tooltip text="Google" placement="top">
                  <a
                    href="http://www.google.com/patrick.benson1995"
                    target="_blank"
              ...
              <li className="social-icons-linkedin">
                <Tooltip text="Linkedin" placement="top">
                  <a
                    href="https://www.linkedin.com/in/patrick-benson-6625a553/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
              ...
              </li>              <li className="social-icons-github">
                <Tooltip text="Github" placement="top">
                  <a
                    href="http://www.github.com/bensonjunior"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
